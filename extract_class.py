...
class Print_Recipe(self, foods):
    def __init__():
        self.prep_time = value[0]
        self.is_vegitarian = value[1]
        self.food_type = value[2]
        self.type_of_cuisine = value[3]
        self.ingredients = value[4]
        self.instructions = value[5]
    ...
    def print_the_stuff():
        for key, value in foods.items():
            ...
            print("Is Veggie?", 'Yes' if self.is_vegitarian else "No")
            print("Food Type:", self.food_type)
            print("Cuisine:", self.type_of_cuisine)
